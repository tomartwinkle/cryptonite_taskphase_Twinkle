...
hacker@man~learning-complex-usage:/challenge$ cat /challenge/challenge
cat: /challenge/challenge: Permission denied
hacker@man~learning-complex-usage:/challenge$ help
...
A star (*) next to a name means that the command is disabled.
 ...
 cd [-L|[-P [-e]] [-@]] [dir]                                                  readarray [-d delim] [-n count] [-O origin] [-s count] [-t] [-u fd] [-C ca>
 ...
 declare [-aAfFgiIlnrtux] [name[=value] ...] or declare -p [-aAfFilnrtux] [n>  source filename [arguments]
 ...
 export [-fn] [name[=value] ...] or export -p                                  typeset [-aAfFgiIlnrtux] name[=value] ... or typeset -p [-aAfFilnrtux] [na>
...
hacker@man~learning-complex-usage:/challenge$ cd /challenge/files
ssh-entrypoint: cd: /challenge/files: No such file or directory
hacker@man~learning-complex-usage:/challenge$ ls /challenge/files
ls: cannot access '/challenge/files': No such file or directory
hacker@man~learning-complex-usage:/challenge$ find /challenge -name "*flag*"
hacker@man~learning-complex-usage:/challenge$ find /challenge
/challenge
/challenge/challenge
/challenge/DESCRIPTION.md
/challenge/.init
hacker@man~learning-complex-usage:/challenge$ find /flag
/flag
hacker@man~learning-complex-usage:/challenge$ cat /flag
cat: /flag: Permission denied
hacker@man~learning-complex-usage:/challenge$ /challenge/challenge --printfile /flag
Correct argument! Here is the /flag file:
pwn.college{cFJMWI7wwbw8-RSuexBpDdawTiA.dVjM5QDLykTN0czW}
```
